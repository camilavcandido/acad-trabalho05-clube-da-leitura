...
namespace ClubeLeitura.ConsoleApp.ModuloCaixa
{
    public class TelaCadastroCaixa
    {
        ...
        public void EditarCaixa()
        {
            ...
            bool temCaixaCadastrada = VisualizarCaixas("Pesquisando");
        ...
        public int ObterNumeroCaixa()
        {
            ...
            do
            {
                ...
                {
                    notificador.ApresentarMensagem("Número de caixa não encontrado, digite novamente",
                        "Atencao");
        ...
        public void ExcluirCaixa()
        {
            ...
            if (temCaixaCadastrada == false)
            {
                notificador.ApresentarMensagem("Nenhuma caixa cadastrada para poder excluir",
                    "Atencao");
                return;
            }
